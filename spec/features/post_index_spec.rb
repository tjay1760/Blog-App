...
RSpec.describe 'Post index ' do
    before :each do
        ...
        @post1 = Post.create(author_id: @user.id, title: 'Hello World', text: 'Hello', likes_counter: 0, comments_counter: 0)
        @post2 = Post.create(author_id: @user.id, title: 'Hello World', text: 'second post', likes_counter: 0, comments_counter: 0)
