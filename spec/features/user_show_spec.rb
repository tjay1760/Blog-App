...
RSpec.describe 'User show', type: :feature do
    before :each do
        @user = User.create(name: 'Tom', photo: 'https://picsum.photos/id/23/200', bio: 'web developer', posts_counter: 0)
        @post1 = Post.create(author_id: @user.id, title: 'Hello', text: 'this is my first post', likes_counter: 0, comments_counter: 0)
        @post2 = Post.create(author_id: @user.id, title: 'Hello ', text: 'this is my second post', likes_counter: 0, comments_counter: 0)
